        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <p className="mb-8">
              ...
              you're a solo entrepreneur, consultant, or growing team, Nouvoice
              adapts to your workflow and scales with your ambition.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-muted/30 p-5 rounded-lg">
                ...
                <p className="text-muted-foreground">
                  ...
                  platform strips away complexity to deliver an intuitive
              ...
              <div className="bg-muted/30 p-5 rounded-lg">
                ...
                <p className="text-muted-foreground">
                  ...
                  platform is built with enterprise-grade security and accuracy
                  as top priorities.
                </p>
              </div>
              <div className="bg-muted/30 p-5 rounded-lg">
            ...
            <p className="mb-4">
              ...
              discovered how many others shared the same pain points. Today,
              we're proud to serve thousands of businesses across Australia and
              beyond, helping them streamline their financial operations.
            </p>
            <p className="mb-8">
