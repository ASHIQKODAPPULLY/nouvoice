  ...
  return (
    <div className="container px-4 py-12 mx-auto">
      ...
      <p className="text-xl text-muted-foreground mb-8">
        Get help with Nouvoice. Browse our knowledge base or contact our support
        team.
      </p>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  To create your first invoice, simply navigate to the dashboard
                  and click on the "Create Invoice" tab. You can then enter a
                  description of your work in natural language, and our AI will
                  generate a professional invoice for you. You can also edit any
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  ...
                  credit/debit cards, PayPal, bank transfers, and cryptocurrency
                  payments. You can configure your preferred payment methods in
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  ...
                  monthly or annually, with annual plans offering a significant
                  discount.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  Yes, Nouvoice offers extensive customization options for your
                  invoice templates. You can add your logo, change colors,
                  adjust layouts, and more. Premium users have access to
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent>
                  ...
                  overdue. You can also generate reports to analyze your payment
                  history.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
