    ...
    <div className="container px-4 py-12 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <p>
              This guide covers everything you need to know to create your first
              invoice using our AI assistant. Learn how to describe your work in
              natural language and get a perfectly formatted invoice in seconds.
            </p>
          </CardContent>
          <CardFooter>
        ...
        <Card>
          ...
          <CardContent>
            <p>
              Learn how to customize the look and feel of your invoices with our
              template editor. Add your logo, change colors, and create a
        ...
        <Card>
          ...
          <CardContent>
            <p>
              ...
              clients. This guide shows you how to configure payment schedules,
        ...
        <Card>
          ...
          <CardContent>
            <p>
              Learn how to use InvoiceGen's dashboard to track payments, manage
              client information, and get insights into your business finances.
            </p>
          </CardContent>
          <CardFooter>
            <Button variant="outline" className="w-full">
