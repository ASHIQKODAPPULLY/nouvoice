  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-12 space-y-8">
      ...
      <div className="space-y-4">
        <p>
          Welcome to Nouvoice. By accessing or using our service, you agree to
        ...
        <p>
          ...
          permitted by law and according to these Terms. You are responsible for
          all activity that occurs under your account.
        </p>

        <h2 className="text-2xl font-semibold mt-8">Account Registration</h2>
        <p>
        ...
        <p>
          Our service and its contents are protected by copyright, trademark,
          and other laws. You may not use our name, logo, or other proprietary
        ...
        <p>
          We may terminate or suspend your account and access to our service at
        ...
        <p>
          ...
          will notify you through our service or by other means, such as email.
        </p>
