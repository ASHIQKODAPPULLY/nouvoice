  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-12 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <h2 className="text-2xl font-semibold mt-8">Why Do We Use Cookies?</h2>
        <p>
          ...
          experience on our website. For example, we use cookies to keep track
          of your preferences, analyze how you use our website, and personalize
          content.
        </p>
        ...
        <h2 className="text-2xl font-semibold mt-8">How to Control Cookies</h2>
        <p>
