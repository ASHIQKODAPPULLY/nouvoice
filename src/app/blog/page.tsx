          ...
          <div className="p-6">
            ...
            <div className="text-muted-foreground mt-4 space-y-4">
              ...
              <p>
                ...
                should match the quality of your work. Include your logo, stick
                to a clean layout, and use legible fonts.
              </p>
              <p>
              ...
              <p>
                Ambiguous terms like "due soon" or "upon receipt" often lead to
                late payments. Specify due dates (e.g., "within 7 days of
              ...
              <p>
                ...
                directly in your invoice, reducing time-to-payment and improving
                client convenience.
              </p>
              ...
              <p>
                Over 70 percent of clients now open invoices on their phones. If
                your invoice is hard to read on mobile, it may be ignored or
                delayed.
              </p>
              <p>
              ...
              <p>
                ...
                businesses in Australia. It's quick to set up, mobile-friendly,
                and built to reduce admin time.
              </p>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li>Avoid late payments with smart tracking and follow-ups</li>
                <li>
